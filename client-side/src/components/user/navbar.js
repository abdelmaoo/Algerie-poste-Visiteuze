          ...
          <div className="mx-auto px-2 sm:px-6 lg:px-8"> { /* max-w-7xl */}
            <div className="relative flex h-16 items-center justify-between">
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-bleu text-white' : 'text-bleu hover:bg-jaune hover:text-bleu',
                          'px-3 mx-6 py-2 rounded-md text-sm font-medium'
                        )}
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0 ">
                ...
                >
                   <span className="p-2 mr-2 text-sm">Se deconnecter</span>
