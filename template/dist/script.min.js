...
jQuery.fn.showOn=function(t){$(this).each(function(){$(this).focus(function(){var n=t.bind[$(this).attr("id")];$(t.target).addClass(n)}).blur(function(){var n=t.bind[$(this).attr("id")];$(t.target).removeClass(n)})})},$(function(){});
